  ...
  document.getElementById('app').innerHTML = `
    ...
    <div class="page" id="page-about">
      <div class="content-page">
        <h1>About<br><span style="color:var(--accent)">UnlockyDoc</span></h1>
        <p class="subtitle">The world's most private PDF unlocker.</p>

        <p>UnlockyDoc was built because PDF passwords are annoying — especially when you're the rightful owner of the file and just need to print, share, or edit it. We built a tool that solves that in under 10 seconds, with zero privacy compromise.</p>

        <p>Unlike other PDF tools that upload your files to a server, UnlockyDoc processes everything directly in your browser using WebAssembly. Your document never touches our servers — because we don't have any file-processing servers.</p>

        <div class="divider"></div>
        <h2>Why choose UnlockyDoc?</h2>
        ...
        <div class="divider"></div>
        <h2>Technology</h2>
        <p>UnlockyDoc uses <strong>pdf-lib</strong>, a powerful open-source JavaScript library, to load your encrypted PDF using your password and then re-save it without any encryption. This happens entirely within the browser's JavaScript sandbox — no extensions, no plugins, no server.</p>

        <p>The domain <strong>unlockydoc.in</strong> is operated independently and is not affiliated with any PDF software vendor.</p>
      </div>
    </div>
    ...
    <div class="page" id="page-privacy">
      <div class="content-page">
        ...
        <p class="subtitle">Last updated: June 2025 &nbsp;·&nbsp; unlockydoc.in</p>

        <h2>Our Core Promise</h2>
        <p><strong>Your files are never uploaded to any server.</strong> All PDF processing on UnlockyDoc happens entirely within your web browser using client-side JavaScript (pdf-lib via WebAssembly). When you select a PDF and enter a password, the decryption happens locally on your device. The resulting unlocked PDF is also created locally and downloaded directly to your device.</p>
        ...
        <p>UnlockyDoc is not directed at children under 13. We do not knowingly collect data from children.</p>

        <h2>Changes to This Policy</h2>
        <p>We may update this privacy policy occasionally. The current version is always available at unlockydoc.in/privacy. Continued use of the service constitutes acceptance of the updated policy.</p>

        <h2>Contact</h2>
        <p>Questions about this privacy policy? Email us at <a href="mailto:privacy@unlockydoc.in">privacy@unlockydoc.in</a>.</p>
      </div>
    </div>
      ...
      <div class="content-page">
        ...
        <div class="contact-cards">
          <div class="contact-card">
            ...
            <a href="mailto:hello@unlockydoc.in">hello@unlockydoc.in</a>
          </div>
          <div class="contact-card">
            <h3>🔒 Privacy & Data</h3>
            <p>Data-related questions, GDPR requests, or privacy concerns.</p>
            <a href="mailto:privacy@unlockydoc.in">privacy@unlockydoc.in</a>
          </div>
        </div>
        ...
        <p>UnlockyDoc supports standard user-password (open password) protected PDFs using RC4 and AES encryption, which covers the vast majority of password-protected PDFs. Owner-only restrictions (print/copy locks without an open password) may also be removed.</p>
    ...
    <footer>
      <div class="footer-inner">
        ...
        <p>© ${new Date().getFullYear()} <span>UnlockyDoc</span> · unlockydoc.in · All PDF processing is 100% client-side</p>
      </div>
    </footer>
  `
...
async function doUnlock() {
  ...
  try {
    ...
    setProgress('Decrypting…', 40)

    // Load encrypted PDF with pdf-lib
    let pdfDoc
    try {
    ...
    setProgress('Removing encryption…', 70)

    // Save without any encryption (pdf-lib strips it by default on save)
    ...
    if (err.message === 'WRONG_PASSWORD') {
      ...
      showStatus('error', `❌ Failed to unlock: ${err.message}. The PDF may use unsupported encryption.`)
